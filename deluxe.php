...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="delux.css">
    ...
    <a href="login.php">Admin</a>
     ...
     padding-left: 250px;
     padding-top: 1100px;">
         <img src="a1.jpg" height="50%" width="50%" style="float: right;">
       </div> 
      <div class="rohead">
        <img src="deluxbg.jpg" alt="Deluxroom Background" height="50%" width="100%" >
    ...
    <div class="roomdes">
      <p>Located on higher floors, with magnificent views of the Arabian Sea.
         These rooms offer a luxurious refugee frantic pace of the city. 
         These rooms also feature a balcony with arched windows offering panoramic views of the sea.</p>
    </div>
      ...
      <div class="roomdes">
        ...
        <ul class="fa-ul">
          ...
          <br>
          <li><i class="fa-li fa fa-bed fa-lg"></i> Bed</li>
          <br>

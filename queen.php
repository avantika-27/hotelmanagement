...
<script src="https://kit.fontawesome.com/a076d05399.js"></script>
    ...
    <a href="login.php">Admin</a>
       ...
       <div class="pic">
         <img src="a2.jpg" height="50%" width="60%" style="float: right;">
       </div> 
      <div class="rohead">
        <img src="queen.jpg" alt="Deluxroom Background" height="50%" width="100%" >
    ...
    <div class="roomdes">
      <p>These picturesque sea-facing suites are carefully designed & lavishly appointed offering
         panoramic views of the Arabian Sea. With a large living area, expansive bedroom and a 
         marble-finished bathroom with a tub, these suites are spacious and airy. The suites also 
         boast of a lovely balcony that overlooks the Gateway of India. These include two way airport 
      ...
      <div class="roomdes">
        <ul class="fa-ul">
          <li><i class="fa-li fa fa-plane fa-lg"></i>Airport Pickup</li>
          <br>
          ...
          <br>
          <li><i class="fa-li fa fa-bed fa-lg"></i>1 Queen Bed</li>
          <br>
...
<div class="slideshow-containerr">
  ...
  <div class="mySlidess fadee">
    ...
    <img src="q1.jpg" style="width:100%" >
  </div>

  <div class="mySlidess fadee">
    <div class="numbertexts"></div>
    <img src="q2.jpg" style="width:100%">
  </div>
  ...
  <div class="mySlidess fadee">
    <div class="numbertexts"></div>
    <img src="q4.jpg" style="width:100%" >
  </div>

  <div class="mySlidess fadee">
    <div class="numbertexts"></div>
    <img src="q5.jpg" style="width:100%">
  </div>

  <div class="mySlidess fadee">
    <div class="numbertexts"></div>
    <img src="q6.jpg" style="width:100%">
  </div>
  <div class="mySlidess fadee">
    <div class="numbertexts"></div>
    <img src="q7.jpg" style="width:100%; height: 50%;" >
  </div>
